...
void DbgFont_SceneRender()
{
	...
	g_DbgFontOverlay.gpu.consts.SrcTexTileSizeUV	= vFloat2(1.0f / 152, 1.0f);
...
static const int CharacterCodeCount	= HighCharacterCode-LowCharacterCode+1;

static void blitToTexture(xBitmapData& dest)
{
	// TODO : Turn this into a single-byte alpha mask

	int2 texdim = { 8 * HighCharacterCode, 8 };
