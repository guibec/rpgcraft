...
extern void         CliParseOption          (const xString& utf8, const xString& file_line_no=xString());
extern void         CliParseOptionRaw       (const xString& utf8, const xString& file_line_no, int startpos=0);
