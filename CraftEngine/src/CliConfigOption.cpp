...
static bool cli_bug_chk_option_enable = true;

void cli_bug_chk_option_complete()
{
    cli_bug_chk_option_enable = false;
}
...
{
    if (!SAVE_SETTINGS_OPTION_CHECK)    return true;
    if (!cli_bug_chk_option_enable)     return true;
