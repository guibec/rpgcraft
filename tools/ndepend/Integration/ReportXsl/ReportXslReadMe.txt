...
To gather XML files at analysis- time you need to activate the option: NDepend Project Properties > Analysis > Output Folder > Keep XML files used to build report.
The Xml information outputed by an analysis can be found in the following Xml files that are in $projectOutputDir$\XmlFilesUsedToBuildReport:
